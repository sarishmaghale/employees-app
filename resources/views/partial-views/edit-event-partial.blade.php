                  ...
                  <form id="editTaskForm">
                      ...
                      <div class="row mb-4">
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control task_start_date datepicker" id="edit_task_start"
                          ...
                          <div class="col-md-6">
                              ...
                              <input type="text" class="form-control task_end_date datepicker" id="edit_task_end"
